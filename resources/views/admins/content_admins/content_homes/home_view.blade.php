    ...
    <div class="container-product-home-admin">
        <div class="wrap-list-product-home-admin row g-4">
            @foreach ($dataProduct['product'] as $item)
                <div class="product-home-admin" data-product-id="{{ $item['productId'] }}">
                    <div class="product-card-home-admin bg-white rounded-4 shadow-sm h-100 position-relative">
                        <a class="overflow-hidden-home-admin" href="{{ route('detail.view', ['id' => $item['productId']]) }}"
                        ...
                        <div class="p-4">
                            ...
                            <div class="d-flex align-items-center-home-admin mb-3">
                                ...
                                <small class=" fw-bold text-muted-home-admin">{{ $item['productQuantity'] }}</small>
                            </div>
